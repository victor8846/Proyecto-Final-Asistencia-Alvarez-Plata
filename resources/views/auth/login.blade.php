    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-8">
        ...
        <div class="relative mb-4">
            <input type="email" id="email" name="email" placeholder="Correo electrónico"
                   class="w-full pl-4 pr-12 py-4 rounded-lg border border-gray-300 bg-blue-50/50 
            ...
            <span class="absolute right-4 top-1/2 transform -translate-y-1/2 text-blue-500">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
                          d="M5.121 17.804A8.962 8.962 0 0112 15c2.485 0 4.735.994 
                             6.379 2.618M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
            </span>
        </div>
        ...
        <div class="relative mb-4">
            ...
            <button type="button" onclick="togglePassword('password')"
                ...
                <svg id="eyeIcon" class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="mt-10">
            <button type="submit"
                    class="w-full bg-gradient-to-r from-green-600 to-green-800 text-white py-5 px-8 text-xl
    ...
    <script>
        function togglePassword(id) {
            ...
            if (input.type === "password") {
                input.type = "text";
                icon.setAttribute("stroke", "green"); // cambia color cuando se muestra
            } else {
                input.type = "password";
